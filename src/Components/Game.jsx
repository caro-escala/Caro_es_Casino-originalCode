...
class Game extends React.Component {
  ...
  add20 = () =>
    this.setState({ availableMoney: this.state.availableMoney + 20 });
  add30 = () =>
    this.setState({ availableMoney: this.state.availableMoney + 30 });
  discount10 = () =>
    this.setState({ availableMoney: this.state.availableMoney - 10 });
      ...
      <div>
        ...
        <div id="cheers" className="alert alert-success invisible" role="alert">
          ...
          <p>
            ...
            <br />
            You have only 5 tries to earn more than 100 coins and become a
            champion!.
          </p>
          <hr />
          <p className="mb-0">
            Caro_es_ca<span className="resalt">sino</span> wishes you luck!!.
          </p>
        </div>
        ...
        <div id="explainCoinTries">
          <div className="card bg-dark text-white expression" id="expression">
            <img src={crupier} class="card-img" alt="..." />
            <div className="card-img-overlay">
              <h5 className="card-title">I'm watching you...</h5>
              <br />
              <p className="card-text result" id="result">
                ...
              </p>
            </div>
          </div>

          <div id="coins" className="card">
        ...
        <div className="cards">
          <img className="card" id="card1" src={card} alt={"card"} />
          <img className="card" id="card2" src={card} alt={"card"} />
          <img className="card" id="card3" src={card} alt={"card"} />
        </div>
        <hr />
